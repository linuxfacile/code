...
runes = [
  ...
  , ["Uruz"     ,"Force"      ,"Santé"]
  , ["Thurisaz" ,"Défense"    ,"Violence"]
  , ["Ansuz"    ,"Conscience" ,"Connaissance"]
  , ["Raidho"   ,"Voyage"     ,"Roue"]
  , ["Kenaz"    ,"Ouverture"  ,"Feu"]
  , ["Gebo"     ,"Rencontre"  ,"Association"]
  , ["Wunjo"    ,"Victoire"   ,"Bonheur"]
  , ["Hagalaz"  ,"Bouleversement","Problème"]
  , ["Naudhiz"  ,"Epreuve"    ,"Contrainte"]
  , ["Isa"      ,"Immobilité" ,"Blocage"]
  , ["Jera"     ,"Causalité"  ,"Récolte"]
  , ["Eihwaz"   ,"Endurance"  ,"Cycle"]
  , ["Perthro"  ,"Mystère"    ,"Destin"]
  , ["Algiz"    ,"Protection" ,"Confiance"]
  , ["Sowilo"   ,"Energie"    ,"Succès"]
  , ["Tiwaz"    ,"Courage"    ,"Justice"]
  , ["Berkano"  ,"Maternité"  ,"Communauté"]
  , ["Ehwaz"    ,"Progrès"    ,"Mouvement"]
  , ["Mannaz"   ,"Humanité"   ,"Intelligence"]
  , ["Laguz"    ,"Fluidité"   ,"Eau"]
  , ["Ingwaz"   ,"Fertilité"  ,"Graine"]
  , ["Dagaz"    ,"Lumière"    ,"Savoir"]
  , ["Othala"   ,"Héritage"   ,"Patrimoine"]
]
